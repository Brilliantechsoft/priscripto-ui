...
import { updatePatientProfile } from "../../../redux/slices/patient/profile/patientProfileSlice";
...
export default function ProfileSection() {
  const { loading, error } = useAppSelector((state) => state.patientProfileUpdate);
  ...
  const handleCountryChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    setStates(country ? country.states.map((s) => s.name) : []);
  ...
  const handleSave = async () => {
    ...
    try {
      const result = await dispatch(updatePatientProfile({ 
      ...
      alert(typeof error === 'string' ? error : "Failed to update profile. Please try again.");
    }
  };
